        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-1">
                ...
                <p class="description-info description-indent">
                    ผู้เข้าลงแข่งการแข่งขันต้องกำลังศึกษาอยู่หรือเคยศึกษาอยู่ในโรงเรียนสวนกุหลาบวิทยาลัย ณ ปีการศึกษา
                    2559
                    เท่านั้น</p>
                ...
                <p class="description-info description-indent">การแข่งขันจะจัดในระบบ Knock-Out (แพ้คัดออก)
                    โดยจะแข่งแบบออนไลน์
                    ยกเว้นในรอบชิงชนะเลิศและชิงที่ 3 จะเป็นการแข่งขันในแบบออฟไลน์ ณ โรงเรียนสวนกุหลาบวิทยาลัย ในระบบ
                    Best of 3
                    (โดยจะพัก 10 นาทีในแต่ละเกม) ในแผนที่ Summoner’s Rift โหมด Tournament Draft (Pick-Ban)
                </p>
                <h3 class="subtitle">ข้อตกลงในการแข่งขัน</h3>
